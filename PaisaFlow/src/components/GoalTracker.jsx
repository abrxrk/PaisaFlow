// FILE: src/components/GoalTracker.jsx
...
const GoalTracker = ({ goals, onUpdate }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      alert("Error: Could not save goal.");
    }
  };
                ...
                <div className="flex justify-between text-sm mt-2 pt-2 border-t">
                  ...
                  <span
                    className={`font-medium ${
                      daysRemaining < 30 ? "text-red-600" : "text-gray-800"
                    }`}
                  >
              ...
              {isAchieved ? (
                ...
                <div className="flex space-x-2">
                  <button
                    ...
                    className="flex-1 bg-green-100 text-green-700 py-2 px-3 rounded-lg hover:bg-green-200 text-sm"
                  >
                    +₹1,000
                  </button>
                  <button
                  ...
                  <button
                    onClick={() => handleProgressUpdate(goal, -1000)}
                    className="flex-1 bg-red-100 text-red-700 py-2 px-3 rounded-lg hover:bg-red-200 text-sm"
                  >
                    -₹1,000
                  </button>
                </div>
